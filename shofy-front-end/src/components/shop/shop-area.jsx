...
const ShopArea = ({ shop_right = false }) => {
  ...
  const hidden_sidebar = isMobile; // true si es móvil, false si es escritorio
    ...
    content = (
      <>
        <ShopContent 
          ...
          hidden_sidebar={hidden_sidebar} // Pasamos el valor calculado de hidden_sidebar
        />

    ...
    if (product_items.length === 0) {
      content = (
        <div className="text-center pt-80 pb-80">
          <h3>No se encontraron <span style={{color:'#000'}}>{searchText}</span> en la busqueda.</h3>
        </div>
      );
    }
                        ...
                        <div className="col-xl-6">
                          ...
                          <div className="tp-shop-top-left d-flex align-items-center ">
                            <div className="tp-shop-top-result">
                              <p>Mostrando 1–{product_items.length} de {all_products.length} resultados</p>
                            </div>
                          </div>
                        ...
                        <div className="col-xl-6">
                          <div className="tp-shop-top-right d-sm-flex align-items-center justify-content-xl-end">
                            <div className="tp-shop-top-select">
                              <NiceSelect
                                options={[
                                  { value: "Short By Price", text: "Ordenar Por Precio" },
                                  { value: "Price low to high", text: "De Menor A Mayor" },
                                  { value: "Price high to low", text: "De Mayor A Menor" },
                                ]}
                                defaultCurrent={0}

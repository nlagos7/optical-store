        ...
        <div className="cartmini__wrapper d-flex justify-content-between flex-column">
          <div className="cartmini__top-wrapper">
                ...
                <div key={i} className="cartmini__widget-item">
                  ...
                  <div className="cartmini__content">
                    ...
                    <div className="cartmini__price-wrapper">
                      {item.discount > 0 ? <span className="cartmini__price">${(Number(item.price) - (Number(item.price) * Number(item.discount)) / 100).toLocaleString('es-ES')}</span> : <span className="cartmini__price">${item.price.toLocaleString('es-ES')}</span>}
            ...
            {cart_products.length === 0 && <div className="cartmini__empty text-center">
              ...
              <Link href="/shop" className="tp-btn">Añadir productos...</Link>
            </div>}
          </div>
          <div className="cartmini__checkout">
            ...
            <div className="cartmini__checkout-btn">
              <Link href="/cart" onClick={handleCloseCartMini} className="tp-btn mb-10 w-100"> Ver carrito</Link>
              <Link href="/checkout" onClick={handleCloseCartMini} className="tp-btn tp-btn-border w-100"> Finalizar compra</Link>
            </div>
          </div>
        </div>
      </div>
